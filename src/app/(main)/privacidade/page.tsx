  ...
  return (
    <div className="min-h-screen app-bg pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <h1 className="text-4xl font-bold text-[var(--text-primary)] mb-8">Política de Privacidade</h1>
        ...
        <div className="prose max-w-none space-y-6 text-[var(--text-secondary)]">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">1. Introdução</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">2. Informações que Coletamos</h2>

            <h3 className="text-xl font-medium text-[var(--text-primary)]">2.1 Informações fornecidas por você</h3>
            ...
            <h3 className="text-xl font-medium text-[var(--text-primary)]">2.2 Informações coletadas automaticamente</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">3. Como Usamos suas Informações</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">4. Armazenamento de Dados</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">5. Compartilhamento de Dados</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">6. Cookies e Tecnologias Similares</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">7. Seus Direitos</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">8. Armazenamento Local</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">9. Menores de Idade</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">10. Alterações nesta Política</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">11. Contato</h2>
            <p>
