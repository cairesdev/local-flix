  ...
  return (
    <div className="min-h-screen app-bg pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <h1 className="text-4xl font-bold text-[var(--text-primary)] mb-8">Termos de Uso</h1>
        ...
        <div className="prose max-w-none space-y-6 text-[var(--text-secondary)]">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">1. Aceitação dos Termos</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">2. Descrição do Serviço</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">3. Uso Permitido</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">4. Contas de Usuário</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">5. Propriedade Intelectual</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">6. Isenção de Responsabilidade</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">7. Limitação de Responsabilidade</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">8. Modificações</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">9. Contato</h2>
            <p>
