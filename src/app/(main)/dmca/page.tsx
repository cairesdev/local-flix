...
export default function DMCAPage() {
  return (
    <div className="min-h-screen app-bg pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <h1 className="text-4xl font-bold text-[var(--text-primary)] mb-8">DMCA - Política de Direitos Autorais</h1>

        <div className="prose max-w-none space-y-6 text-[var(--text-secondary)]">
          {/* Important Notice */}
          <div className="bg-[var(--warning-accent)]/10 border border-[var(--warning-accent)]/30 rounded-xl p-6 flex gap-4">
            <AlertTriangle className="text-[var(--warning-accent)] flex-shrink-0 mt-1" size={24} />
            <div>
              <h3 className="text-lg font-semibold text-[var(--warning-accent)] mb-2">Aviso Importante</h3>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">O que é DMCA?</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Nossa Posição</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Notificação de Violação</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Como Enviar uma Notificação</h2>

            <div className="bg-[var(--bg-secondary)] rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                <Mail className="text-[var(--accent-primary)]" size={24} />
                <h3 className="text-xl font-medium text-[var(--text-primary)]">Via GitHub</h3>
              </div>
              <p>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 mt-4 px-6 py-3 bg-[var(--accent-primary)] text-[var(--text-primary)] rounded-lg hover:opacity-90 transition-opacity"
              >
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Processo de Remoção</h2>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <CheckCircle className="text-[var(--success-accent)] flex-shrink-0 mt-1" size={20} />
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Contra-Notificação</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Infratores Reincidentes</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-[var(--text-primary)]">Isenção de Responsabilidade</h2>
            <p>
