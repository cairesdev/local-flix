...
/**
 * Catálogo de filmes/séries/animes. Antes era a página inicial ("/") - o
 * app agora foca em TV ao vivo como produto principal (veja
 * src/app/(main)/page.tsx, que redireciona "/" para "/tv"), então este
 * catálogo passou para sua própria rota e continua acessível pelo menu.
 */
